...
///*************************************************************************
// *  Compilation:  javac Maze.javapackage test;
...
*/
    ...
    private void solve(int x, int y) {
    	...
    	while(current_traversal.agent_x != current.agent_x || current_traversal.agent_y != current.agent_y){
    		...
    		String[] nextState = current_traversal_text.split(" ");
    		int x_next = Integer.parseInt(nextState[0]);
    		int y_next = Integer.parseInt(nextState[1]);
    		current_traversal = new State(x_next, y_next);
    	}
//    	
    	while(!list.isEmpty()){
...
//			System.out.println(closedSet);
    ...
    public static void main(String[] args) {
        ...
        aStarSolver maze = new aStarSolver(N);
        StdDraw.show(0);
        maze.draw();
        maze.solve();
